function Data_Results=Test_CTnumber_estimation_accuracy(CTnumbers,Data_Results)
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Compute the accuracy of the CT numbers estimation based on the phantom inserts:
